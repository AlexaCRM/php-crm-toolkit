...
class AlexaSDK extends AlexaSDK_Abstract{
	...
	protected static $maximumRecords = self::MAX_CRM_RECORDS;
        ...
        function __construct(AlexaSDK_Settings $_settings, $_debug = NULL) {
            ...
            $this->cacheClass = new AlexaSDK_Cache( array('storage' => 'auto'));
	 ...
	 */
        public function getEntityFormByName($entity, $formName){
            ...
            $request = '<RetrieveMultiple xmlns="http://schemas.microsoft.com/xrm/2011/Contracts/Services">
            ...
            $doc = new DOMDocument();
            $doc->loadXML($request);
            $executeNode = $doc->getElementsByTagName('RetrieveMultiple')->item(0);
            
            $request = $this->generateSoapRequest($this->settings->organizationUrl, $this->getOrganizationRetrieveMultipleAction(), $securityToken, $executeNode);
            
            $soapResponse = self::GetSOAPResponse($this->settings->organizationUrl, $request);
